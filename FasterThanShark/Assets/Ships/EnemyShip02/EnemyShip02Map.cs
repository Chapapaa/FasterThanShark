...
public class EnemyShip02Map : MonoBehaviour
{
    ...
    void Initialize()
    {
        ...
        map.Add(new ShipRoom(4, new Engine(), cell0.position, cell1.position, cell4.position, cell5.position, Room0.position));
        map.Add(new ShipRoom(4, repairEngine, cell2.position, cell3.position, cell6.position, cell7.position, Room1.position));
        map.Add(new ShipRoom(2, new Engine(), cell8.position, cell10.position, Room2.position));
        map.Add(new ShipRoom(2, new Engine(), cell9.position, cell11.position, Room3.position));
        map.Add(new ShipRoom(2, weaponEngine, cell12.position, cell16.position, Room4.position));
        map.Add(new ShipRoom(4, new Engine(), cell13.position, cell14.position, cell17.position, cell18.position, Room5.position));
        map.Add(new ShipRoom(2, medicEngine, cell15.position, cell19.position, Room6.position));
        map.Add(new ShipRoom(2, new Engine(), cell20.position, cell21.position, Room7.position));
        map.Add(new ShipRoom(2, new Engine(), cell22.position, cell23.position, Room8.position));
        map.Add(new ShipRoom(2, new Engine(), cell24.position, cell25.position, Room9.position));
        map.Add(new ShipRoom(4, navigationEngine, cell26.position, cell27.position, cell28.position, cell29.position, Room10.position));
